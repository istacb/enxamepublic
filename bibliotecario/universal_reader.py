...
class UniversalDocumentReader:
    ...
    def _extract_text_odf(self, path: Path) -> str:
        ...
        try:
            ...
            from odf.textextractor import ODFTextExtractor, extractText  # type: ignore
    ...
    def split_into_chunks(self, text: str, metadata: dict) -> list[DocumentChunk]:
        ...
        while start < len(normalized):
            ...
            chunk_id = hashlib.sha1(f'{metadata["source_path"]}:{chunk_index}:{chunk_text[:80]}'.encode()).hexdigest()
