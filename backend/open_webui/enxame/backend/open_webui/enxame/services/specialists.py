...
class SpecialistService:
    def __init__(self):
        self.specialist_types = ['general', 'programmer', 'writer', 'analyst', 'researcher']

    async def dispatch(self, query: str, context: SearchResult, agent_role: str = 'general') -> list[AgentResponse]:
        """
        ...
        responses = [
            AgentResponse(
                ...
                confidence=0.85,
                metadata={'model': 'llama3', 'context_used': len(context.chunks)},
                execution_time=0.5,
            )
        ]
