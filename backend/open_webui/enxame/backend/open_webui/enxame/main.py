...
async def handle_query(request: QueryRequest):
    ...
    try:
        ...
        mission = await controller.process_request(query=request.query, user_id=request.user_id)
...
async def health_check():
    ...
    return {'status': 'healthy', 'plugin': 'enxame-os', 'version': '1.0.0', 'enabled': settings.enabled}
