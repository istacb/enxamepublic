...
from ..models.schemas import ThreatLevel, ValidationResult
    ...
    def validate(self, text: str) -> ValidationResult:
        ...
        if threats:
            return ValidationResult(
                allowed=False, threat_level=ThreatLevel.HIGH, reasons=threats, actions=['block_request', 'log_incident']
            )
...
class Guard:
    def __init__(self):
        self.validators: list[Validator] = [JailbreakValidator(), InjectionValidator()]
